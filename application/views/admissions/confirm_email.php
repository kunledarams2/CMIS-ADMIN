...
Please check your email to activate before you can continue.  </b></b></p>
 ...
 <div align="center">
        <script src="https://js.paystack.co/v1/inline.js"></script>
         <button type="button"  class="btn_1 rounded medium add_top_30" id="btn_activate_email" onclick="location .href='<?php echo site_url() ?>admissions/login'"> Continue</button>

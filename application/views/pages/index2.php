...
<body>
	...
	<header class="header menu_2">
		...
		<div id="logo">
			<a href=""><img src="assets/img/logo.png" width="100" height="40" data-retina="true" alt=""></a>
		</div>
		<ul id="top_menu">
		...
		<nav id="menu" class="main-menu">
			<ul>
				...
				<li><span><a href="#0">About CMIS</a></span>
					<ul>
						<li><a href="">CMIS Overview</a></li>
				...
				<li><span><a href="#0">Products & Services </a></span>
					<ul>
						<li><a href="#0">Pre-School MIS (PreSMIS) </a></li>
						<li><a href="">Primary School MIS (PrySMIS)</a></li>
	...
	<main>
		...
		<section class="header-video">
			...
			<div id="hero_video">
				<div>
					<h3><strong>Welcome to</strong><br>JETA Communication's College Management Information System (CMIS)</h3>
					<p>CMIS is a digital platform that automates Secondary Schools/Colleges operations such as <strong> admission, registration, class attendance, learning management, payments, clinic operations, result processing and general administrative activities. </strong></p>
				</div>
		...
		<ul id="grid_home" class="clearfix">
			<li>
				<a href="#0" class="img_container">
					<img src="/assets/img/student_teacher_image1.jpg" width="600" height="600" data-retina="true"  alt="">
					<div class="short_info">
						<h3><strong>Learning Management</strong>System</h3>
			...
			<li>
				<a href="#0" class="img_container">
					<img src="" alt="">
					<div class="short_info">
						<h3><strong>Class Attendance </strong>Management</h3>
						<div><span class="btn_1 rounded">Read more</span></div>
					</div>
				</a>
			</li>
			<li>
				<a href="#0" class="img_container">
					<img src="" alt="">
					<div class="short_info">
						<h3><strong>Admission Management</strong> System</h3>
						<div><span class="btn_1 rounded">Read more</span></div>
					</div>
				</a>
			</li>
		...
		<div class="container margin_120_95">
			<div class="row">
				<div class="col-lg-5 col-md-12 p-r-5">
					...
					<p>JETA CMIS marks your school out as an ICT compliant and smart institution.</p>
					<div class="follow_us">
						<ul>
							<li>Follow us</li>
				...
				<div class="col-lg-3 col-md-6">
					...
					<ul class="contacts">
						<li><a href="tel://61280932400"><i class="ti-mobile"></i> +234 08101096623</a></li>
						<li><a href="mailto:info@udema.com"><i class="ti-email"></i> jetacomms@gmail.com</a></li>
					</ul>
					<div id="newsletter">
					<h6>Newsletter</h6>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div id="copy">© 2020 JETA Communications</div>
				</div>
			</div>
		</div>
	</footer>

...
<head>
  ...
  <title>CMIS - Admin dashboard</title>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Bookings">
          <a class="nav-link" href="courses.html">
            ...
            <span class="nav-link-text">New Application <span class="badge badge-pill badge-primary">6 New</span></span>
          </a>
        </li>
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Reviews">
          <a class="nav-link" href="reviews.html">
            <i class="fa fa-fw fa-star"></i>
            <span class="nav-link-text">Reviews Addmission</span>
          </a>
        </li>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><h5>26 Teacher</h5></div>
            </div>
          ...
          <div class="card dashboard text-white bg-warning o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
				...
				<div class="mr-5"><h5>101 Students</h5></div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><h5>20 New Online Application</h5></div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><h5>100 Student Admit</h5></div>
            </div>
